...
@section('title')
World SLIM BIM Model | Global BIM Dashboard
@stop
...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
		    <h1 class="page-header">SLIM BIM Model of {{$data['country']}}</h1>
		</div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
  ...
  <div class="panel panel-default">
                        <div class="panel-heading">
                            <b>SLIM BIM Model of {{$data['country']}}</b> 
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
		<canvas id="triangle" width="400px" height="400px"></canvas>
				</div>
			</div>
			</div>
			</div>
