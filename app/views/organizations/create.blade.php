...
<div class="container">
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><b>Add Your Organization</b></h3>
                    </div>
			...
			{{ Form::open(array('route' => 'organizations.store', 'files' => true))  }}

				<div class="form-group">

					{{ Form::select('category',array(''=>'What is the category of your organization?','1'=>'University','2'=>'Research Center','3'=>'Governmental Organization','4'=>'Others'),Input::old('category'),array('class'=>'form-control')) }}
				...
				<div class="form-group">
					Please upload the logo of organization. The image should be 128 *128 size png file.
					{{ Form::file('image') }}
				</div>	
