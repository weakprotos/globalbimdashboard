...
<div id="page-wrapper">
		...
		{{ Form::select('language',array(''=>'Select Language', 'spanish'=>'Español','french'=>'Français','russian'=>'русский','english'=>'English','chinese'=>'中文', 'arabic'=>'العربية'),Input::old('language'),array('class'=>'form-control')) }}
		</div>
