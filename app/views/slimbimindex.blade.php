	...
	<section id="about">
		...
		<!--<div class="header-content-inner">-->
			...
			<div class="col-lg-8 col-lg-offset-2">
				...
				<p></p>
			<div class="col-lg-8 col-lg-offset-2 text-center">
		                <a href="{{URL::to("slimbim#chart")}}" class="btn btn-primary btn-xl">Slim BIM charts</a>
		...
		<aside class="bg-dark">
			<div class="container text-center">
				<div class="call-to-action">
					...
					<a href="{{URL::to('slimbimsurvey')}}" class="btn btn-default btn-xl wow tada">Join our slim BIM survey</a>
				</div>
			</div>
		</aside>
		</div>
